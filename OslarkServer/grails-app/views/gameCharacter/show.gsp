...
<html>
    ...
    <body>
        ...
        <div id="show-gameCharacter" class="content scaffold-show" role="main">
            ...
            <f:display bean="gameCharacter" />
            <g:form resource="${this.gameCharacter}" method="DELETE">
                <fieldset class="buttons">
                    %{--<g:link class="edit" action="edit" resource="${this.gameCharacter}"><g:message code="default.button.edit.label" default="Edit" /></g:link>--}%
